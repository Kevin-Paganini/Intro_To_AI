#
# test_dungeon3.py: creates various dungeon configurations and provides
...
def main() -> int:
    ...
    result.
    """
    n = int(input("Enter test number (1-7; 0 = run 1-7): "))
