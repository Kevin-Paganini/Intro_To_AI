...
def test_rat_1(algorithm, debug: bool = False) -> str:
    ...
    path = rat.directions_to(last, algorithm)
...
def test_rat_2(algorithm, debug: bool = False) -> str:
    ...
    path = rat.directions_to(target, algorithm)

    #If you are getting 'top left', 'bottom left', 'bottom right' for you
    #path for DFS, you need to reverse the list of neighbors returned
    #by Room.
...
def rat_in_looped_dungeon() -> Rat:
    ...
    # r0 -> r1, r1 -> r2, r1 -> r3; r2 -> r0, r3 -> r4, r4 -> r5
...
def test_rat_4(algorithm, debug: bool = False) -> str:
    ...
    path = rat.directions_to(impossible_goal, algorithm)
...
def test_rat_5(algorithm, debug: bool = False) -> str:
    ...
    path = rat.directions_to(goal, algorithm)
